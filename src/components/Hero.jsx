...
export default function HeroSection() {
  return (
    <section className="relative flex flex-col-reverse md:flex-row items-center justify-between px-6 py-16 bg-black text-white">
      <div className="md:w-1/2">
        ...
        <div className="flex gap-4">
          <Link href="https://topmate.io/psychemaster_india" target="_blank">
            <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-md cursor-pointer text-base">
              Book a Session
            </button>
          </Link>
          <Link href="/about">
